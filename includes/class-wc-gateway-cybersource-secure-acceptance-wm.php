...
?>
		...
		<br>
		<input type="submit" name="confirm_pay" value="<?php _e( '  Confirm and Pay  ', WC_Cybersource_Secure_Acceptance_WM::TEXT_DOMAIN ) ?>" class="elementor-button-link elementor-button elementor-size-sm alt" /> <a href="<?php echo $this->get_payment_page_url( $order, true ) ?>">&nbsp;<?php _e( 'Back', WC_Cybersource_Secure_Acceptance_WM::TEXT_DOMAIN ) ?></a>
	</form>
	...
	private function get_payment_page_url( $order, $choose_payment_page = false )
	{
		...
		if ( $choose_payment_page ) return add_query_arg( array( 'order_id' => $order->id), $payment_page );
